...
const exercises = [
    { notes: ['c/4', 'd/4'], num: '2', qual: 'M' },
    { notes: ['a/4', 'f/4'], num: '3', qual: 'M' },
    { notes: ['g/4', 'b/4'], num: '3', qual: 'M' },
    { notes: ['b/4', 'c/5'], num: '2', qual: 'm' },
    { notes: ['f/4', 'd/4'], num: '3', qual: 'm' },
    { notes: ['e/4', 'f/4'], num: '2', qual: 'm' },
    { notes: ['d/4', 'f/4'], num: '3', qual: 'm' },
    { notes: ['c/4', 'e/4'], num: '3', qual: 'M' },
    { notes: ['c/5', 'a/4'], num: '3', qual: 'm' },
    { notes: ['f/4', 'g/4'], num: '2', qual: 'M' },
    { notes: ['b/4', 'd/5'], num: '3', qual: 'm' },
    { notes: ['a/4', 'g/4'], num: '2', qual: 'M' },
    { notes: ['a/4', 'f/4'], num: '3', qual: 'M' },
